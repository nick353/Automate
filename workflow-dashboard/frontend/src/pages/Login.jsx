...
import { Workflow, Mail, Lock, Loader2, AlertCircle, ArrowRight, Terminal } from 'lucide-react'
...
export default function Login() {
  ...
  const { signIn, isLoading, authEnabled, initialize } = useAuthStore()
    ...
    return (
      <div className="min-h-screen min-h-[100dvh] bg-background flex items-center justify-center p-4">
        <div className="relative">
          <div className="w-12 h-12 sm:w-16 sm:h-16 border-2 border-primary/30 border-t-primary rounded-sm animate-spin" />
    ...
    <div className="min-h-screen min-h-[100dvh] bg-background text-foreground flex items-center justify-center p-3 sm:p-4 relative overflow-hidden transition-colors duration-300">
      ...
      >
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            <GlitchText>WORKFLOW</GlitchText>
            <span className="block text-primary dark:text-cyan-400 text-sm sm:text-base lg:text-lg font-mono tracking-[0.2em] sm:tracking-[0.3em] mt-1">NEXUS OS</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          ...
          {!authEnabled && (
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-sm p-3 sm:p-4 mb-4 sm:mb-6">
